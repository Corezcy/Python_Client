...
class Controllable:
    ...
    def object_state(self):
        j = self.remote.command(
            "controllable/object_state/get", {"uid": self.uid})
    ...
    def current_state(self):
        j = self.remote.command(
            "controllable/current_state/get", {"uid": self.uid})
        return j["state"]

    @property
    def control_policy(self):
        j = self.remote.command(
            "controllable/control_policy/get", {"uid": self.uid})
